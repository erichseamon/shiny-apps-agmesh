function(){
        tabPanel("Help",
                 HTML('
<h3><p><strong>DMINE Agriculture Dashboard: Insurance Crop Claim Animation</strong><br/></h3>
...
<a href="https://dmine.io/ag-commodity-loss-dashboard-animation/", style="text-decoration:underline;", target="_parent">Claim Animation</a> |
