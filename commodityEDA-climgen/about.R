function(){
        tabPanel("Help",
                 HTML('
<h3><p><strong>DMINE Agriculture Dashboard: Insurance Crop Claim Data Mining</strong><br/></h3>


<a href="https://dmine.io/ag-commodity-loss-mining/", target="_parent">Data Mining</a> |s
