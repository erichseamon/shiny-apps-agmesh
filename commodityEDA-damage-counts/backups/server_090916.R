...
#output$plot <- renderImage({
    ...
    # Generate the PNG
    #setwd("/dmine/data/USDA/crop_indemnity_raster_commodity_plots/")
    #rrr <- readJPEG(paste(input$year, ".", "1", ".", input$commodity, "_plot.jpeg", sep=""), native=TRUE)    
    #plot(0:480, type='n', xlab="", ylab="", axes=FALSE)
    #rasterImage(rrr, 0,0,480,480)
#})
  ...
  output$plot <- renderPlot({ 
    ...
    setwd("/dmine/data/USDA/crop_indemnity_raster_commodity_plots/") 
    r1 <- readJPEG(paste(input$year, ".", "1", ".", input$commodity, "_plot.jpeg", sep=""))
    r2 <- readJPEG(paste(input$year, ".", "2", ".", input$commodity, "_plot.jpeg", sep=""))
    r3 <- readJPEG(paste(input$year, ".", "3", ".", input$commodity, "_plot.jpeg", sep=""))
    r4 <- readJPEG(paste(input$year, ".", "4", ".", input$commodity, "_plot.jpeg", sep=""))
    r5 <- readJPEG(paste(input$year, ".", "5", ".", input$commodity, "_plot.jpeg", sep=""))
    r6 <- readJPEG(paste(input$year, ".", "6", ".", input$commodity, "_plot.jpeg", sep=""))
    r7 <- readJPEG(paste(input$year, ".", "7", ".", input$commodity, "_plot.jpeg", sep=""))
    r8 <- readJPEG(paste(input$year, ".", "8", ".", input$commodity, "_plot.jpeg", sep=""))
    r9 <- readJPEG(paste(input$year, ".", "9", ".", input$commodity, "_plot.jpeg", sep=""))
    r10 <- readJPEG(paste(input$year, ".", "10", ".", input$commodity, "_plot.jpeg", sep=""))
    r11 <- readJPEG(paste(input$year, ".", "11", ".", input$commodity, "_plot.jpeg", sep=""))
    r12 <- readJPEG(paste(input$year, ".", "12", ".", input$commodity, "_plot.jpeg", sep=""))
