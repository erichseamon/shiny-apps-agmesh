function(){
        tabPanel("Help",
                 HTML('
<h3><p><strong>DMINE Agriculture Dashboard: Insurance Crop Claim Loss vs. Climate</strong><br/></h3>
...
<a href="https://dmine.io/ag-dashboard-palouse-crop-claims-vs-climate/", style="text-decoration:underline;", target="_parent">Loss vs Climate</a> |
