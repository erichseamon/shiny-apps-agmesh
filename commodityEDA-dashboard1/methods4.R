...
<div style="clear: left;"><img src="https://dmine.io/wp-content/uploads/22.png" alt="" style="float:right; width: 40% ; margin-right:15px" /></div>'),
		
		HTML('
<h5><strong>Agricultural Commodity Loss - County Level Analysis </strong></h5>
